...
public class ParetoEstimate {
    ...
    private static void calcularEstadisticas(List<Double> fitnesses, String nombreInstancia, String objetivo) {
        ...
        // Comparación de distribuciones con Kolmogorov-Smirnov Test
        if (fitnesses.size() > 1) {
            ...
            // Comparación con Mann-Whitney U-Test
            MannWhitneyUTest mannWhitneyUTest = new MannWhitneyUTest();
            double pValueMW = mannWhitneyUTest.mannWhitneyUTest(distribucion1, distribucion2);
            System.out.println("p-value (Mann-Whitney U-Test): " + pValueMW);
        }
        System.out.println();
    }
