...
- Al ejecutar el programa el usuario debe indicar el nombre de la instancia a evaluar (incluyendo extension), si quiere que se generen graficos de las soluciones y si se quiere generar un archivo excel para las soluciones (incluyendo las conseguidas por los greedys).
...
Ejecuta cada combinación 30 veces, generando un análisis estadístico de los resultados, como la ganancia promedio, diversidad, hipervolumen y tiempo de ejecución. 
